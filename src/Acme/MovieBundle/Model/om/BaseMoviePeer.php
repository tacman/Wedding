...
use Acme\MovieBundle\Model\map\MovieTableMap;
...
abstract class BaseMoviePeer {
	...
	const OM_CLASS = 'Acme\\MovieBundle\\Model\\Movie';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'src.Acme.MovieBundle.Model.Movie';
	...
	const IS_PUBLISHED = 'movies.IS_PUBLISHED';
	...
	const PRODUCER_ID = 'movies.PRODUCER_ID';
