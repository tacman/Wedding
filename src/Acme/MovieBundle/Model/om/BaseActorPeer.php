...
use Acme\MovieBundle\Model\map\ActorTableMap;

/**
 * Base static class for performing query and update operations on the 'actors' table.
 *
 * 
 *
...
abstract class BaseActorPeer {
	...
	const OM_CLASS = 'Acme\\MovieBundle\\Model\\Actor';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'src.Acme.MovieBundle.Model.Actor';
	...
	/**
	 * Method to invalidate the instance pool of all tables related to actors
