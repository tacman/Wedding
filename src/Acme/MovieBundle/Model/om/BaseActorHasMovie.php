...
/**
 * Base class that represents a row from the 'actors_movies' table.
 *
 * 
 *
...
abstract class BaseActorHasMovie extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'Acme\\MovieBundle\\Model\\ActorHasMoviePeer';
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(ActorHasMoviePeer::ACTOR_ID)) {
			$modifiedColumns[':p' . $index++]  = '`ACTOR_ID`';
		}
		if ($this->isColumnModified(ActorHasMoviePeer::MOVIE_ID)) {
			$modifiedColumns[':p' . $index++]  = '`MOVIE_ID`';
		}

		$sql = sprintf(
			'INSERT INTO `actors_movies` (%s) VALUES (%s)',
