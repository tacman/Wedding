...
#$databaselocation   =   'rack3.smokescreen.org';   // Network location of your Database - for odbc_mssql or mssqlnative use the mssql servername, not localhost or IP
...
$databasename       =   'db_lime_wedding';  // The name of the database that we will create
$databaseuser       =   'lime';        // The name of a user with rights to create db (or if db already exists, then rights within that db)
$databasepass       =   'l1m3';            // Password of db user
/*
$databaselocation   =   'cari1.smokescreen.org';   // Network location of your Database - for odbc_mssql or mssqlnative use the mssql servername, not localhost or IP
$databasename       =   'db_lime3';  // The name of the database that we will create
$databaseuser       =   'lime';        // The name of a user with rights to create db (or if db already exists, then rights within that db)
$databasepass       =   'l1m3';            // Password of db user
*/
$supportedLanguagesKeys = 'en';

$dbprefix           =   '';       // A global prefix that can be added to all LimeSurvey tables. Use this if you are sharing
// a database with other applications. Suggested prefix is 'lime_'

// File Locations
$rooturl            =   "http://{$_SERVER['HTTP_HOST']}/rsvp"; // The root web url for your limesurvey installation (without a trailing slash).
...
$defaultpass        =   'nosmoke';        // This is the password for the administration user when LimeSurvey is installed
